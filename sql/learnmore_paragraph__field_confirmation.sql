...
--
-- Table structure for table `paragraph__field_confirmation`
--

DROP TABLE IF EXISTS `paragraph__field_confirmation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_confirmation` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_confirmation.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_confirmation`
--

LOCK TABLES `paragraph__field_confirmation` WRITE;
/*!40000 ALTER TABLE `paragraph__field_confirmation` DISABLE KEYS */;
INSERT INTO `paragraph__field_confirmation` VALUES ('subscribe',0,417,512,'en',0,'I hereby confirm my subscription to the URBACT newsletter and I agree to its  legal notice.');
/*!40000 ALTER TABLE `paragraph__field_confirmation` ENABLE KEYS */;
UNLOCK TABLES;
