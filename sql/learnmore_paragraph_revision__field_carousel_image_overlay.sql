...
--
-- Table structure for table `paragraph_revision__field_carousel_image_overlay`
--

DROP TABLE IF EXISTS `paragraph_revision__field_carousel_image_overlay`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph_revision__field_carousel_image_overlay` (
...
--
-- Dumping data for table `paragraph_revision__field_carousel_image_overlay`
--

LOCK TABLES `paragraph_revision__field_carousel_image_overlay` WRITE;
/*!40000 ALTER TABLE `paragraph_revision__field_carousel_image_overlay` DISABLE KEYS */;
INSERT INTO `paragraph_revision__field_carousel_image_overlay` VALUES ('carousel',0,413,490,'en',0,237,'','',690,388),('carousel',0,413,507,'en',0,237,'','',690,388);
/*!40000 ALTER TABLE `paragraph_revision__field_carousel_image_overlay` ENABLE KEYS */;
UNLOCK TABLES;
