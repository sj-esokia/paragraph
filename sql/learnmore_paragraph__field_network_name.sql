...
--
-- Table structure for table `paragraph__field_network_name`
--

DROP TABLE IF EXISTS `paragraph__field_network_name`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_network_name` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_network_name.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_network_name`
--

LOCK TABLES `paragraph__field_network_name` WRITE;
/*!40000 ALTER TABLE `paragraph__field_network_name` DISABLE KEYS */;
INSERT INTO `paragraph__field_network_name` VALUES ('network',0,418,513,'en',0,'URBACT IV Networks'),('network',0,419,514,'en',0,'Partner cities'),('network',0,420,515,'en',0,'Countries involved');
/*!40000 ALTER TABLE `paragraph__field_network_name` ENABLE KEYS */;
UNLOCK TABLES;
