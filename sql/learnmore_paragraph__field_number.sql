...
--
-- Table structure for table `paragraph__field_number`
--

DROP TABLE IF EXISTS `paragraph__field_number`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_number` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_number.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_number`
--

LOCK TABLES `paragraph__field_number` WRITE;
/*!40000 ALTER TABLE `paragraph__field_number` DISABLE KEYS */;
INSERT INTO `paragraph__field_number` VALUES ('network',0,418,513,'en',0,30),('network',0,419,514,'en',0,252),('network',0,420,515,'en',0,28);
/*!40000 ALTER TABLE `paragraph__field_number` ENABLE KEYS */;
UNLOCK TABLES;
