...
--
-- Table structure for table `paragraph_revision__field_carousel_button`
--

DROP TABLE IF EXISTS `paragraph_revision__field_carousel_button`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph_revision__field_carousel_button` (
