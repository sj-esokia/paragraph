...
--
-- Table structure for table `paragraph__field_toolbox_description`
--

DROP TABLE IF EXISTS `paragraph__field_toolbox_description`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_toolbox_description` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_toolbox_description.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_toolbox_description`
--

LOCK TABLES `paragraph__field_toolbox_description` WRITE;
/*!40000 ALTER TABLE `paragraph__field_toolbox_description` DISABLE KEYS */;
INSERT INTO `paragraph__field_toolbox_description` VALUES ('urbact_toolbox',0,425,520,'en',0,'Your set of tools and resources to shape better cities!\r\n\r\n \r\n\r\nSometimes it can be difficult to know where to start. URBACT makes sure cities have the right tools to spark change, one step at a time.\r\n\r\nMaybe you have an idea for an innovative and sustainable policy? Or perhaps you’ve identified a pressing challenge in your city that has to be solved?\r\n\r\nThe URBACT Toolbox has everything you need to design and implement integrated and participatory actions in your city.');
/*!40000 ALTER TABLE `paragraph__field_toolbox_description` ENABLE KEYS */;
UNLOCK TABLES;
