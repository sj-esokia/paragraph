...
--
-- Table structure for table `paragraph__field_knowledge_image`
--

DROP TABLE IF EXISTS `paragraph__field_knowledge_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_knowledge_image` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_knowledge_image.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_knowledge_image`
--

LOCK TABLES `paragraph__field_knowledge_image` WRITE;
/*!40000 ALTER TABLE `paragraph__field_knowledge_image` DISABLE KEYS */;
INSERT INTO `paragraph__field_knowledge_image` VALUES ('knowledge_hub',0,421,516,'en',0,232,'Localising the 2030 Agenda','',90,90),('knowledge_hub',0,422,517,'en',0,233,'Mobility','',90,90),('knowledge_hub',0,423,518,'en',0,234,'Food and sustainable local systems','',90,90),('knowledge_hub',0,424,519,'en',0,235,'Gender Equality','',89,90);
/*!40000 ALTER TABLE `paragraph__field_knowledge_image` ENABLE KEYS */;
UNLOCK TABLES;
