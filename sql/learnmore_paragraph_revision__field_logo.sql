...
--
-- Table structure for table `paragraph_revision__field_logo`
--

DROP TABLE IF EXISTS `paragraph_revision__field_logo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph_revision__field_logo` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Revision archive storage for paragraph field field_logo.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph_revision__field_logo`
--

LOCK TABLES `paragraph_revision__field_logo` WRITE;
/*!40000 ALTER TABLE `paragraph_revision__field_logo` DISABLE KEYS */;
/*!40000 ALTER TABLE `paragraph_revision__field_logo` ENABLE KEYS */;
UNLOCK TABLES;
