...
--
-- Table structure for table `paragraph__field_knowledgehubtitle`
--

DROP TABLE IF EXISTS `paragraph__field_knowledgehubtitle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_knowledgehubtitle` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_knowledgehubtitle.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_knowledgehubtitle`
--

LOCK TABLES `paragraph__field_knowledgehubtitle` WRITE;
/*!40000 ALTER TABLE `paragraph__field_knowledgehubtitle` DISABLE KEYS */;
INSERT INTO `paragraph__field_knowledgehubtitle` VALUES ('knowledge_hub',0,421,516,'en',0,' Knowledge Hub');
/*!40000 ALTER TABLE `paragraph__field_knowledgehubtitle` ENABLE KEYS */;
UNLOCK TABLES;
