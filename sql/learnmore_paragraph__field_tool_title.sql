...
--
-- Table structure for table `paragraph__field_tool_title`
--

DROP TABLE IF EXISTS `paragraph__field_tool_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_tool_title` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_tool_title.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_tool_title`
--

LOCK TABLES `paragraph__field_tool_title` WRITE;
/*!40000 ALTER TABLE `paragraph__field_tool_title` DISABLE KEYS */;
INSERT INTO `paragraph__field_tool_title` VALUES ('tools',0,426,521,'en',0,'Problem tree'),('tools',0,427,522,'en',0,'Action Table'),('tools',0,428,523,'en',0,'Opera'),('tools',0,429,524,'en',0,'Four C\'s');
/*!40000 ALTER TABLE `paragraph__field_tool_title` ENABLE KEYS */;
UNLOCK TABLES;
