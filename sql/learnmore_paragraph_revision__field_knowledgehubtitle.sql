...
--
-- Table structure for table `paragraph_revision__field_knowledgehubtitle`
--

DROP TABLE IF EXISTS `paragraph_revision__field_knowledgehubtitle`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph_revision__field_knowledgehubtitle` (
  ...
  `field_knowledgehubtitle_value` varchar(255) NOT NULL,
...
--
-- Dumping data for table `paragraph_revision__field_knowledgehubtitle`
--

LOCK TABLES `paragraph_revision__field_knowledgehubtitle` WRITE;
/*!40000 ALTER TABLE `paragraph_revision__field_knowledgehubtitle` DISABLE KEYS */;
INSERT INTO `paragraph_revision__field_knowledgehubtitle` VALUES ('knowledge_hub',0,421,440,'en',0,' Knowledge Hub'),('knowledge_hub',0,421,452,'en',0,' Knowledge Hub'),('knowledge_hub',0,421,464,'en',0,' Knowledge Hub'),('knowledge_hub',0,421,481,'en',0,' Knowledge Hub'),('knowledge_hub',0,421,498,'en',0,' Knowledge Hub'),('knowledge_hub',0,421,516,'en',0,' Knowledge Hub');
/*!40000 ALTER TABLE `paragraph_revision__field_knowledgehubtitle` ENABLE KEYS */;
UNLOCK TABLES;
