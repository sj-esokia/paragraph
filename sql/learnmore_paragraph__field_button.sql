...
--
-- Table structure for table `paragraph__field_button`
--

DROP TABLE IF EXISTS `paragraph__field_button`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_button` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_button.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_button`
--

LOCK TABLES `paragraph__field_button` WRITE;
/*!40000 ALTER TABLE `paragraph__field_button` DISABLE KEYS */;
INSERT INTO `paragraph__field_button` VALUES ('tools',0,426,521,'en',0,141),('tools',0,427,522,'en',0,54),('tools',0,428,523,'en',0,31),('tools',0,429,524,'en',0,56);
/*!40000 ALTER TABLE `paragraph__field_button` ENABLE KEYS */;
UNLOCK TABLES;
