...
--
-- Table structure for table `paragraph__field_toolbox_title`
--

DROP TABLE IF EXISTS `paragraph__field_toolbox_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_toolbox_title` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_toolbox_title.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_toolbox_title`
--

LOCK TABLES `paragraph__field_toolbox_title` WRITE;
/*!40000 ALTER TABLE `paragraph__field_toolbox_title` DISABLE KEYS */;
INSERT INTO `paragraph__field_toolbox_title` VALUES ('urbact_toolbox',0,425,520,'en',0,'URBACT Toolbox');
/*!40000 ALTER TABLE `paragraph__field_toolbox_title` ENABLE KEYS */;
UNLOCK TABLES;
