...
--
-- Table structure for table `paragraph__field_email_address`
--

DROP TABLE IF EXISTS `paragraph__field_email_address`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paragraph__field_email_address` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Data storage for paragraph field field_email_address.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paragraph__field_email_address`
--

LOCK TABLES `paragraph__field_email_address` WRITE;
/*!40000 ALTER TABLE `paragraph__field_email_address` DISABLE KEYS */;
INSERT INTO `paragraph__field_email_address` VALUES ('subscribe',0,417,512,'en',0,'Subscribe@gmail.com');
/*!40000 ALTER TABLE `paragraph__field_email_address` ENABLE KEYS */;
UNLOCK TABLES;
